...
import { FaStar, FaHeart, FaFemale, FaMale, FaCalendarAlt, FaInfoCircle ,FaUser,FaHome} from "react-icons/fa";
...
export default function FemaleDoctors() {
  ...
  return (
    <div className="h-screen bg-[#EEF3FF] px-4 pt-6">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <h1 className="text-blue-600 font-semibold">Female</h1>
